    ...
    <section className="relative py-24 lg:py-32 bg-secondary/30" id="workflow">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Connection line */}
          <div className="hidden lg:block absolute top-[60px] left-[10%] right-[10%] h-[2px] bg-gradient-to-r from-border/25 via-primary/30 to-border/25" />
            ...
            {WORKFLOW_STEPS.map((step, index) => (
              ...
              >
                ...
                <div className="relative z-10 mb-5">
                  <div className="flex h-[120px] w-[120px] items-center justify-center rounded-full landing-glass shadow-md">
                    <div className="flex h-[80px] w-[80px] items-center justify-center rounded-full bg-primary/10 border border-primary/20">
                  ...
                  {/* Pulse dot */}
                  <div className="absolute top-1 right-1 h-3 w-3 rounded-full bg-primary/60 animate-pulse" />
                </div>

                {/* Label */}
                <h3 className="font-heading text-base font-semibold mb-2">{step.label}</h3>
